...
<div class="chat-screen">
    ...
    <div class="chat-mail">
        <div class="row">
            <div class="col-md-12 text-center mb-2">
                <p>Hi 👋! Please fill out the form below to start chatting.</p>
            </div>
        </div>
        <div class="row">
            <!-- <div class="col-md-12">
    ...
    <div class="chat-body hide">
        ...
        <div class="chat-bubble you">Welcome to our site, if you need help simply reply to this message, we are ready to help.</div>
